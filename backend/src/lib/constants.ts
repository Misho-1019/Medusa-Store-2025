 ...
 */
export const BACKEND_URL = process.env.MEDUSA_BACKEND_URL ?? (process.env.RAILWAY_PUBLIC_DOMAIN_VALUE ? `https://${process.env.RAILWAY_PUBLIC_DOMAIN_VALUE}` : 'http://localhost:9000')
/**
